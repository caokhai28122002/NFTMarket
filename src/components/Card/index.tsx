    ...
    <div className={styles.parent}>
      <div className={styles.card}>
        <div className={styles.logo}>
          <span className={clsx(styles.circle, styles.circle1)}></span>
          <span className={clsx(styles.circle, styles.circle2)}></span>
          <span className={clsx(styles.circle, styles.circle3)}></span>
          <span className={clsx(styles.circle, styles.circle4)}></span>
          <span className={clsx(styles.circle, styles.circle5)}>
            <svg className={styles.svg} viewBox="0 0 100 100" fill="white">
        ...
        <div className={styles.bottom}>
          <div className={styles.socialButtonsContainer}>
            <button className={clsx(styles.socialButton ,styles.socialButton1)}>
              <svg
                viewBox="0 0 30 30"
