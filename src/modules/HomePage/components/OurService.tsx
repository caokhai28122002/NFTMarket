  ...
  return (
    <div className="flex flex-col w-full items-center gap-16 px-8">
      ...
      <div className='w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8'>
        <div className='flex flex-col hover:bg-[rgba(224,91,255,0.1608)] hover:border-[5px] border-[#E05BFF] rounded-[20px] w-full h-96 xl:h-[612px] justify-center items-center gap-8 xl:gap-16'>
          <Menu/>
